...
const NewsPage = () => {
  ...
  const {
    ...
    error: categoryError,
  } = useNewsByCategory(selectedCategory);
  ...
  const isLoading =
    selectedCategory === "general" ? headlinesLoading : categoryLoading;
      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="body1" color="text.secondary">
            Stay updated with the latest market news, mergers, currency updates,
            and forex insights
          </Typography>
        </Box>
        ...
        {!isLoading && (
          <Box sx={{ mb: 3, display: "flex", alignItems: "center", gap: 2 }}>
            ...
            <Chip
              label={
                predefinedCategories.find((cat) => cat.key === selectedCategory)
                  ?.label || "All News"
              }
              size="small"
              color="primary"
                        ...
                        <Box
                          sx={{
                            ...
                            display: {
                              ...
                              md: "block", // show on small and up
                            },
                            background: news.image
                              ? `url(${news.image}) center/cover no-repeat`
                              : `linear-gradient(135deg, ${getCategoryColor(
                                  selectedCategory
                                )}20, ${getCategoryColor(selectedCategory)}40)`,
                            position: "relative",
                            alignItems: "center",
                            ...
                            <Box sx={{ display: "flex", gap: 1 }}>
                              <Tooltip title="Add to favorites">
                                <IconButton
                                  size="small"
                                  onClick={(e) =>
                                    handleAddToWishlist(news.newsId, e)
                                  }
                                  disabled={
                                  ...
                                  sx={{
                                    color: isInWishlist(news.newsId)
                                      ? "error.main"
                                      : "grey.400",
                                    "&:hover": { color: "error.main" },
                                  }}
                                >
                                  {isInWishlist(news.newsId) ? (
                                    <Star />
                                  ) : (
                                    <StarBorder />
                                  )}
          ...
          <>
            <Box sx={{ position: "relative" }}>
              ...
              >
                <Chip
                  label={
                    selected.category?.replace(/\b\w/g, (l) =>
                      l.toUpperCase()
                    ) || "General"
                  }
                  size="small"
                ...
                <Box sx={{ display: "flex", gap: 1 }}>
                  <Tooltip title="Add to favorites">
                    <IconButton
                      ...
                      sx={{
                        color: isInWishlist(selected.newsId)
                          ? "error.main"
                          : "grey.400",
                        "&:hover": { color: "error.main" },
                      }}
                    >
                      {isInWishlist(selected.newsId) ? (
                        <Star />
                      ) : (
                        <StarBorder />
                      )}
